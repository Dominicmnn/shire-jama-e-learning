...
# Render supplies DATABASE_URL. SQLite remains available for local development.
DATABASES = {
...
# Keeps large video binaries outside PostgreSQL and supports local disk / object storage
MEDIA_URL = '/media/'
